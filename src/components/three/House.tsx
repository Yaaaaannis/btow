...
import { MeshPhysicalMaterial, DoubleSide, BufferAttribute, RectAreaLight, PointLight, HemisphereLight } from 'three'
...
export function House(props: any) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      {/* Lumière ambiante douce venant du dessus */}
      <hemisphereLight
        args={["#ffe066", "#888888", 1.5]}
        position={[0.208, 2.589, 0.797]}
        intensity={0.5}
      />
      {/* Point de lumière au sommet entre les deux jonctions du toit */}
      <pointLight
        color="#ffe066"
        intensity={100}
        position={[2, 7.5, -3]}
